...
| `exist()` | 判断目录是否存在 | `void -> boolean` |
| `make()` | 创建目录 | `void -> Directory` |
| `existOrMake()` | 不存在则创建 | `void -> Directory` |
...
| `generate()` | 生成随机文件/目录 | `void -> Directory\|File` |
