...
| 名称                                     | 描述                   | 类型                                              |
| ---------------------------------------- | ---------------------- | ------------------------------------------------- |
| `load()`                                 | 从磁盘加载块内容       | `() => FileBlock`                                 |
| `flush()`                                | 将内存状态写回磁盘     | `() => FileBlock`                                 |
| `listFiles()`                            | 获取块内全部条目       | `() => entry[]`                                   |
...
| 名称                                       | 描述                   | 类型                                                  |
| ------------------------------------------ | ---------------------- | ----------------------------------------------------- |
| `load()`                                   | 扫描目录并重建索引     | `() => UnorderedBlockAllocator`                       |
| `listBlocks()`                             | 查看块统计信息         | `() => blockInfo[]`                                   |
...
| `compact()`                                | 尝试压缩小块           | `() => UnorderedBlockAllocator`                       |
