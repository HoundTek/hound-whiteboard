...
本文档提供 `Viewport`（UI 侧视口 facade）的概述。Worker 侧 `ViewportCore` 参见 [viewport-core-document.md](../../../../worker/components/orchestration/docs/viewport-core-document.md)。
...
- [viewport-core-document.md](../../../../worker/components/orchestration/docs/viewport-core-document.md)
