 ...
 * @property {(objectInstances: BasicObject[], fallbackChunks: import("../chunk/chunk.js").Chunk[], previousWorldRects: Map<number, import("../../range/index.js").RectangleRange>) => void} requestBaseRenderForObjects
